            ...
            <Card className={"rounded-lg max-h-[275px]"}>
                ...
                <CardContent>
                    {deployments.length > 0 ? (
                        <div className="grid gap-0 overflow-scroll max-h-[110px]  text-sm">
                        ...
                        <div
                            className="rounded-lg border-2 border-dashed border-border p-4 text-center grid place-items-center h-full w-full">
