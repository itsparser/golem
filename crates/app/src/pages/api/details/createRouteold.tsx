...
const GatewayBindingType = z.enum([
    "Default", "FileServer", "HttpHandler", "CorsPreflight"
]);
...
const HttpApiDefinitionRequest = z.object({
    id: z.string(),
    version: z.string(),
...
type RouteFormValues = z.infer<typeof HttpApiDefinitionRequest>;
...
const routeSchema = z.object({
    ...
    bindType: z.enum(BIND_TYPE).default("Default"),
...
const CreateRoute = () => {
    ...
    const form = useForm<HttpApiDefinitionRequestValues>({
        resolver: zodResolver(HttpApiDefinitionRequest),
        defaultValues: {
            id: "",
            version: "",
            security: [],
